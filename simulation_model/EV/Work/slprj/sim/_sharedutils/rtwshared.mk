...
MODEL                = rtwshared
MODULES              = look1_binlcapw.c look2_binlcapw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c look1_binlcpw.c look1_iflf_binlcpw.c look1_iflf_binlxpw.c sumColumnB_5SJvnzJT.c automldiffls_oVvi23Xz.c automldiffopen_ujNuWwNk.c interp2_Dz8B5aYN.c look1_binlxpw.c rt_zcfcn.c getExpmParams_wY8zD8EB.c log2_88lh625s.c look1_pbinlcapw.c norm_doJDoZY6.c recomputeBlockDiag_jaPUPAO1.c xhseqr_9pzSUODQ.c look1_pbinlxpw.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c binsearch_u32d.c intrp2d_la_pw.c plook_binca.c
PRODUCT              = rtwshared.lib
MAKEFILE             = 
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023b
START_DIR            = D:/Full_EV_Model_WithBatTemp/EV/Work
S_FUNCTIONS_LIB      = 
NUMST                = 
NCSTATES             = 0
BUILDARGS            =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="C:\\Program Files\\MATLAB\\R2023b" RSIM_PARAMETER_LOADING=1 OPTS="-DNRT -DIS_SIM_TARGET -DTGTCONN -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
