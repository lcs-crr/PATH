...
MODULES              = SOC_Estimation_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/SOC_Estimation_msf.mexw64
MAKEFILE             = SOC_Estimation.mk
...
MODELLIB                  = SOC_Estimation_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/SOC_Estimation/SOC_Estimationlib.lib
MODELREF_LINK_RSPFILE     = SOC_Estimation_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/SOC_Estimation \
...
SOC_Estimation_msf.obj : $(START_DIR)/slprj/sim/SOC_Estimation/SOC_Estimation_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/SOC_Estimation/SOC_Estimation_msf.c
