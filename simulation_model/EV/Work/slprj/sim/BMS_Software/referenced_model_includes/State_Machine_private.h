...
#define rtmDisableTaskUsingRateIndex(rtm, sti) simTgtDisableTaskUsingRateIndex(_ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[sti])
#endif
#ifndef rtmEnableTaskUsingRateIndex
#define rtmEnableTaskUsingRateIndex(rtm, sti) simTgtEnableTaskUsingRateIndex(_ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[sti])
#endif
...
#endif
typedef struct { boolean_T kr03fzfjkx ; boolean_T ogmupjm0m5 ; boolean_T
an5dgwec5n ; boolean_T oqdhql1gcd ; boolean_T pez2ljzyrs ; boolean_T
lmhdntl05l ; } buucjg4jzbe ; typedef struct { real32_T jtpcbqwj1b ;
MonitorCellTempModeType fb5bbiuli2 ; MonitorCellVoltageModeType k1sc13r5jo ;
MonitorCurrLimModeType bcekey302t ; uint16_T mwasiirt2d ; uint16_T j3phsmcbus
; uint16_T khtdtbeu2o ; uint8_T hwhe1k5q4h ; uint8_T cf30f2bj5n ; uint8_T
lmhfpg5xlx ; uint8_T pypsy0ekj2 ; uint8_T ermkbsqag3 ; uint8_T klib31xflx ;
uint8_T kdwlrmjvxu ; uint8_T jjivha0b04 ; uint8_T czumf21qzq ; boolean_T
d0ijd3w5tb ; Contact lx3h213vga ; Contact p2jbicc1yl ; } ajo5azz2auj ; struct
nphnkzl1z3p_ { real_T P_0 ; real32_T P_1 ; real32_T P_2 ; real32_T P_3 ;
...
uint8_T P_14 ; } ; struct i3du3bnr0k { struct SimStruct_tag * _mdlRefSfcnS ;
...
#define rtmGetClockTick0(rtm) ssGetClockTick( _ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[0])
#endif
#ifndef rtmGetClockTickH0
#define rtmGetClockTickH0(rtm) ssGetClockTickH( _ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[0])
#endif
#ifndef rtmGetLogOutput
#define rtmGetLogOutput(rtm) ssGetLogOutput((rtm)->_mdlRefSfcnS)
#endif
#ifndef rtmSetSampleHit
#define rtmSetSampleHit(rtm, sti, tid, val) _ssSetSampleHit(_ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[sti], val)
#endif
#ifndef rtmIsSampleHit
#define rtmIsSampleHit(rtm, sti, tid) ssIsSampleHit( _ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[sti], tid)
#endif
#ifndef rtmGetT
...
#define rtmGetTNextWasAdjusted(rtm, sti) (ssGetTNextWasAdjusted((rtm)->_mdlRefSfcnS,  ct2eelkn4y[sti]))
#endif
#ifndef rtmGetTStart
#define rtmGetTStart(rtm) (ssGetTStart((rtm)->_mdlRefSfcnS))
#endif
#ifndef rtmGetTaskTime
#define rtmGetTaskTime(rtm, sti) ssGetTaskTime( _ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[sti])
#endif
#ifndef rtmSetTaskTime
#define rtmSetTaskTime(rtm, sti, val) _ssSetTaskTime(_ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[sti], val)
#endif
#ifndef rtmGetTimeOfLastOutput
#define rtmGetTimeOfLastOutput(rtm) (ssGetTimeOfLastOutput((rtm)->_mdlRefSfcnS))
#endif
#ifndef rtmGetVarNextHitTime
#define rtmGetVarNextHitTime(rtm, sti) (_ssGetVarNextHitTime((rtm)->_mdlRefSfcnS,  (int)(ssGetOffsetTime(_ssGetRootSS((rtm)->_mdlRefSfcnS), ct2eelkn4y[sti+1]))))
#endif
#ifndef rtmSetVarNextHitTime
#define rtmSetVarNextHitTime(rtm, sti, val) ssSetTimeOfNextVarHit((rtm)->_mdlRefSfcnS,  ct2eelkn4y[sti], val)
#endif
typedef struct { p4isk5qdk5 rtm ; } dqjxrtn4kxw ; extern int_T ct2eelkn4y [ 1
] ; extern nphnkzl1z3p jxf1g2kobi ; extern dqjxrtn4kxw dqjxrtn4kx ; extern
buucjg4jzbe guzb1fdrpj0 ; extern ajo5azz2auj o5dhcpjtr50 ;
#endif
