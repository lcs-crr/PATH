...
MODEL                = BMS_Software
MODULES              = BMS_Software_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/BMS_Software_msf.mexw64
MAKEFILE             = BMS_Software.mk
...
CLASSIC_INTERFACE    = 0
MODELREFS            = Balancing_Logic BMS_Out CurrPowerLimCalc SOC_Estimation State_Machine 
SHRLIBTARGET         = 1
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"C:\Program Files\MATLAB\R2023b\extern\lib\win64\microsoft" -L"C:\Program Files\MATLAB\R2023b/extern/lib/win64/microsoft" libmwipp.lib libfixedpoint.lib libmwmathutil.lib libmwsl_AsyncioQueue.lib sf_runtime.lib libmwslexec_simlog.lib libmwcoder_ToAsyncQueueTgtAppSvc.lib libmwsl_simtarget_instrumentation.lib libmwsl_simtarget_core.lib libmwstringutil.lib libemlrt.lib libmx.lib libmex.lib
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 0

#--------------------------- Model and reference models -----------------------
MODELLIB                  = BMS_Software_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/BMS_Software/BMS_Softwarelib.lib D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/BMS_Out/BMS_Outlib.lib D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/Balancing_Logic/Balancing_Logiclib.lib D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/CurrPowerLimCalc/CurrPowerLimCalclib.lib D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/SOC_Estimation/SOC_Estimationlib.lib D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/State_Machine/State_Machinelib.lib
MODELREF_LINK_RSPFILE     = BMS_Software_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR)\slprj\sim\BMS_Software\mex\referenced_model_includes \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/BMS_Software \
...
BMS_Software_msf.obj : $(START_DIR)/slprj/sim/BMS_Software/BMS_Software_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/BMS_Software/BMS_Software_msf.c
