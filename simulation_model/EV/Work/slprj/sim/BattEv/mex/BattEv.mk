...
MODEL                = BattEv
MODULES              = BattEv_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/BattEv_msf.mexw64
MAKEFILE             = BattEv.mk
...
MODELLIB                  = BattEv_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model/EV/Work/slprj/sim/BattEv/BattEvlib.lib
...
BattEv_msf.obj : $(START_DIR)/slprj/sim/BattEv/BattEv_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/BattEv/BattEv_msf.c
