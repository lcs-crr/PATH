...
MODULES              = MotGenEvMapped_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/MotGenEvMapped_msf.mexw64
...
MODELLIB                  = MotGenEvMapped_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model/EV/Work/slprj/sim/MotGenEvMapped/MotGenEvMappedlib.lib
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/MotGenEvMapped \
...
MotGenEvMapped_msf.obj : $(START_DIR)/slprj/sim/MotGenEvMapped/MotGenEvMapped_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/MotGenEvMapped/MotGenEvMapped_msf.c
