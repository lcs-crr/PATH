...
MODEL                = State_Machine
MODULES              = State_Machine_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/State_Machine_msf.mexw64
MAKEFILE             = State_Machine.mk
...
MODELLIB                  = State_Machine_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model/EV/Work/slprj/sim/State_Machine/State_Machinelib.lib
MODELREF_LINK_RSPFILE     = State_Machine_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/State_Machine \
...
State_Machine_msf.obj : $(START_DIR)/slprj/sim/State_Machine/State_Machine_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/State_Machine/State_Machine_msf.c
