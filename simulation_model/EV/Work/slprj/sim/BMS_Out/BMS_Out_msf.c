...
; boolean_T const * i_fwrew5uymp = ( boolean_T * ) ssGetInputPortSignal ( S ,
6 ) ; BMS_Cmd * o_B_1_1 = ( BMS_Cmd * ) ssGetOutputPortSignal ( S , 0 ) ;
...
if ( tid == 0 ) { BMS_Out ( i_icorvig1rb , i_oor20c2qm4 , i_ct3cx2czh5 ,
i_kkdng1ywtj , i_oz41yprirc , i_ageaq3iofq , i_fwrew5uymp , o_B_1_1 , o_B_1_2
, o_B_1_3 , o_B_1_4 , o_B_1_5 , o_B_1_6 , o_B_1_7 , o_B_1_8 , o_B_1_9 ,
o_B_1_10 , o_B_1_11 ) ; } } static void mdlInitializeSizes ( SimStruct * S )
...
7 , 11 ) ; if ( ! ssSetNumInputPorts ( S , 7 ) ) return ; if ( !
...
; ssSetInputPortSampleTime ( S , 0 , 0.1 ) ; ssSetInputPortOffsetTime ( S , 0
, 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 1 , 1 ) ) return ;
...
; ssSetInputPortSampleTime ( S , 2 , 0.1 ) ; ssSetInputPortOffsetTime ( S , 2
, 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 3 , 1 ) ) return ;
...
; ssSetInputPortSampleTime ( S , 3 , 0.1 ) ; ssSetInputPortOffsetTime ( S , 3
, 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 4 , 1 ) ) return ;
...
( S , 5 , 0.0 ) ; if ( ! ssSetInputPortVectorDimension ( S , 6 , 96 ) )
...
false ) ; ssSetInputPortSampleTime ( S , 6 , 5.0 ) ; ssSetInputPortOffsetTime
( S , 6 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 11 ) ) return ; if ( !
...
ssSetOutputPortOptimOpts ( S , 10 , SS_NOT_REUSABLE_AND_LOCAL ) ;
...
BMS_State_Enum * o_B_1_10 = ( BMS_State_Enum * ) ssGetOutputPortSignal ( S ,
9 ) ; real32_T * o_B_1_11 = ( real32_T * ) ssGetOutputPortSignal ( S , 10 ) ;
if ( tid != CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { BMS_Out (
i_icorvig1rb , i_oor20c2qm4 , i_ct3cx2czh5 , i_kkdng1ywtj , i_oz41yprirc ,
i_ageaq3iofq , i_fwrew5uymp , o_B_1_1 , o_B_1_2 , o_B_1_3 , o_B_1_4 , o_B_1_5
, o_B_1_6 , o_B_1_7 , o_B_1_8 , o_B_1_9 , o_B_1_10 , o_B_1_11 ) ; } } static
void mdlTerminate ( SimStruct * S ) { knzl4yur3r ( ) ; return ; }
