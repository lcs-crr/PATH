...
MODEL                = BMS_Out
MODULES              = BMS_Out_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/BMS_Out_msf.mexw64
MAKEFILE             = BMS_Out.mk
...
MODELLIB                  = BMS_Out_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model/EV/Work/slprj/sim/BMS_Out/BMS_Outlib.lib
MODELREF_LINK_RSPFILE     = BMS_Out_ref.rsp
...
BMS_Out_msf.obj : $(START_DIR)/slprj/sim/BMS_Out/BMS_Out_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/BMS_Out/BMS_Out_msf.c
