...
MODULES              = Balancing_Logic_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Balancing_Logic_msf.mexw64
MAKEFILE             = Balancing_Logic.mk
...
MODELLIB                  = Balancing_Logic_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model/EV/Work/slprj/sim/Balancing_Logic/Balancing_Logiclib.lib
MODELREF_LINK_RSPFILE     = Balancing_Logic_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/Balancing_Logic \
...
Balancing_Logic_msf.obj : $(START_DIR)/slprj/sim/Balancing_Logic/Balancing_Logic_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/Balancing_Logic/Balancing_Logic_msf.c
