...
#define S_FUNCTION_NAME Balancing_Logic_msf
#endif
...
static void mdlInitializeConditions ( SimStruct * S ) { boolean_T *
o_o_o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; ke3bmpbgy1 (
o_o_o_B_2_1 ) ; } static void mdlReset ( SimStruct * S ) { boolean_T *
o_o_o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; epo0ltx0d0 (
o_o_o_B_2_1 ) ; } static void mdlPeriodicOutputUpdate ( SimStruct * S , int_T
tid ) { BMS_State_Enum const * i_igrbiryzep = ( BMS_State_Enum * )
ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_ax05b1cnad = ( real32_T *
) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_otz5bvh0df = ( real32_T
* ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_hu12u5bthb = (
real32_T * ) ssGetInputPortSignal ( S , 3 ) ; boolean_T * o_o_o_B_2_1 = (
boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid == 0 ) {
Balancing_Logic ( i_igrbiryzep , i_ax05b1cnad , i_otz5bvh0df , i_hu12u5bthb ,
o_o_o_B_2_1 ) ; } } static void mdlInitializeSizes ( SimStruct * S ) { if ( (
S -> mdlInfo -> genericFcn != ( NULL ) ) && ( ! ( S -> mdlInfo -> genericFcn
...
slmrInitializeIOPortDataVectors ( S , 4 , 1 ) ; if ( ! ssSetNumInputPorts ( S
...
) return ; ssSetInputPortDataType ( S , 0 , dataTypeIdReg ) ; }
#endif
...
mr_Balancing_Logic_RegisterSimStateChecksum ( S ) ; ssSetNumSampleTimes ( S ,
...
mr_Balancing_Logic_MdlInfoRegFcn ( S , "Balancing_Logic" , & retVal ) ; if (
! retVal ) return ; }
#endif
...
= 0 ; } evmer3ke3c ( S , slmrGetTopTidFromMdlRefChildTid ( S , 0 , false ) ,
sysRanPtr , sysTid , ( ( NULL ) ) , ( ( NULL ) ) , 0 , - 1 ) ;
ssSetModelMappingInfoPtr ( S , & ( j3u401rova . rtm . DataMapInfo . mmi ) ) ;
if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S ->
mdlInfo -> genericFcn ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { } static void mdlOutputs ( SimStruct
* S , int_T tid ) { BMS_State_Enum const * i_igrbiryzep = ( BMS_State_Enum *
) ssGetInputPortSignal ( S , 0 ) ; real32_T const * i_ax05b1cnad = ( real32_T
* ) ssGetInputPortSignal ( S , 1 ) ; real32_T const * i_otz5bvh0df = (
real32_T * ) ssGetInputPortSignal ( S , 2 ) ; real32_T const * i_hu12u5bthb =
( real32_T * ) ssGetInputPortSignal ( S , 3 ) ; boolean_T * o_o_o_B_2_1 = (
boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ; if ( tid != CONSTANT_TID &&
tid != PARAMETER_TUNING_TID ) { Balancing_Logic ( i_igrbiryzep , i_ax05b1cnad
, i_otz5bvh0df , i_hu12u5bthb , o_o_o_B_2_1 ) ; } } static void mdlTerminate
( SimStruct * S ) { fqfmn1ydgn ( ) ; return ; }
...
mr_Balancing_Logic_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0 , 1 , mdlrefDW
) ; } { mxArray * data = mr_Balancing_Logic_GetSimStateDisallowedBlocks ( ) ;
...
( localX , & rawData [ 0 ] , numBytes ) ; } mr_Balancing_Logic_SetDWork (
