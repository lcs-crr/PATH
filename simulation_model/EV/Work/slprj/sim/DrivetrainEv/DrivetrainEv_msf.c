...
real_T rtP_wheel_diameter ; const char * rt_GetMatSignalLoggingFileName (
...
& ( rtP_wheel_diameter ) , GlobalPrm_0 , sizeof ( real_T ) ) ; } }
#endif
...
ssGetInputPortSignal ( S , 3 ) ; real_T * o_B_20_1 = ( real_T * )
ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_20_2 = ( real_T * )
ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_20_3 = ( real_T * )
ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_20_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_20_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_20_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_20_7 = ( real_T * )
ssGetOutputPortSignal ( S , 6 ) ; real_T * o_B_20_8 = ( real_T * )
ssGetOutputPortSignal ( S , 7 ) ; edp3webv0p * localX = ( edp3webv0p * )
ssGetContStates ( S ) ; bbuzvmnhsa * localXdis = ( bbuzvmnhsa * )
ssGetContStateDisabled ( S ) ; if ( tid == 0 ) { DrivetrainEv ( & ( dw -> rtm
) , i_ohqozwr3bt , i_m5lcvgivpn , i_fp2cs4ko5p , i_pldc422xqt , o_B_20_1 ,
o_B_20_2 , o_B_20_3 , o_B_20_4 , o_B_20_5 , o_B_20_6 , o_B_20_7 , o_B_20_8 ,
& ( dw -> rtb ) , & ( dw -> rtdw ) , localX , localXdis , & ( dw -> rtzce ) )
...
( S , 3 , 0.0 ) ; if ( ! ssSetNumOutputPorts ( S , 8 ) ) return ; if ( !
...
2 ] ; ssNonContDerivSigFeedingOutports mr_nonContOutput5 [ 2 ] ;
ssNonContDerivSigFeedingOutports mr_nonContOutput6 [ 2 ] ;
ssNonContDerivSigFeedingOutports mr_nonContOutput7 [ 2 ] ;
...
mr_nonContOutput4 ; mr_nonContOutputArray [ 5 ] = mr_nonContOutput5 ;
mr_nonContOutputArray [ 6 ] = mr_nonContOutput6 ; mr_nonContOutputArray [ 7 ]
= mr_nonContOutput7 ; ktxb3gprz3 ( S , mr_nonContOutputArray ,
...
, GEN_FCN_REG_MODELREF_NONCONTSIGS , 4 , mr_nonContOutput4 ) ) return ; if (
! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 5 , mr_nonContOutput5 ) )
return ; if ( ! ( fcn ) ( S , GEN_FCN_REG_MODELREF_NONCONTSIGS , 6 ,
mr_nonContOutput6 ) ) return ; if ( ! ( fcn ) ( S ,
GEN_FCN_REG_MODELREF_NONCONTSIGS , 7 , mr_nonContOutput7 ) ) return ; } }
#define MDL_START
static void mdlStart ( SimStruct * S ) { hmke5fx3tcj * dw = ( hmke5fx3tcj * )
ssGetDWork ( S , 0 ) ; mdlProcessParameters ( S ) ; ka5dospcnh ( & ( dw ->
rtb ) , & ( dw -> rtdw ) ) ; }
#define RTW_GENERATED_ENABLE
static void mdlEnable ( SimStruct * S ) { hmke5fx3tcj * dw = ( hmke5fx3tcj *
) ssGetDWork ( S , 0 ) ; bbuzvmnhsa * localXdis = ( bbuzvmnhsa * )
ssGetContStateDisabled ( S ) ; lcrhwa0gkm ( & ( dw -> rtm ) , & ( dw -> rtdw
) , localXdis ) ; return ; }
...
tid ) { hmke5fx3tcj * dw = ( hmke5fx3tcj * ) ssGetDWork ( S , 0 ) ; real_T
const * i_ohqozwr3bt = ( real_T * ) ssGetInputPortSignal ( S , 0 ) ; real_T
const * i_m5lcvgivpn = ( real_T * ) ssGetInputPortSignal ( S , 1 ) ; real_T
const * i_fp2cs4ko5p = ( real_T * ) ssGetInputPortSignal ( S , 2 ) ; real_T
const * i_pldc422xqt = ( real_T * ) ssGetInputPortSignal ( S , 3 ) ; real_T *
o_B_20_1 = ( real_T * ) ssGetOutputPortSignal ( S , 0 ) ; real_T * o_B_20_2 =
( real_T * ) ssGetOutputPortSignal ( S , 1 ) ; real_T * o_B_20_3 = ( real_T *
) ssGetOutputPortSignal ( S , 2 ) ; real_T * o_B_20_4 = ( real_T * )
ssGetOutputPortSignal ( S , 3 ) ; real_T * o_B_20_5 = ( real_T * )
ssGetOutputPortSignal ( S , 4 ) ; real_T * o_B_20_6 = ( real_T * )
ssGetOutputPortSignal ( S , 5 ) ; real_T * o_B_20_7 = ( real_T * )
...
i_m5lcvgivpn , i_fp2cs4ko5p , i_pldc422xqt , o_B_20_1 , o_B_20_2 , o_B_20_3 ,
o_B_20_4 , o_B_20_5 , o_B_20_6 , o_B_20_7 , o_B_20_8 , & ( dw -> rtb ) , & (
dw -> rtdw ) , localX , localXdis , & ( dw -> rtzce ) ) ; } } }
#define MDL_UPDATE
static void mdlUpdate ( SimStruct * S , int_T tid ) { hmke5fx3tcj * dw = (
hmke5fx3tcj * ) ssGetDWork ( S , 0 ) ; ekz3w3o33e ( & ( dw -> rtm ) , & ( dw
-> rtdw ) ) ; return ; }
...
rtm ) ; mxArray * nonContDerivSigInfo = mxCreateCellMatrix ( 8 , 1 ) ; for (
int i = 0 ; i < 8 ; ++ i ) { mxArray * prevValmxArray = mxCreateNumericMatrix
...
i < 8 ; ++ i ) { mxArray * prevValmxArray = mxGetCell ( nonContDerivSigInfo ,
