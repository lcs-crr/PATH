...
MODEL                = DrivetrainEv
MODULES              = DrivetrainEv_msf.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/DrivetrainEv_msf.mexw64
...
MODELLIB                  = DrivetrainEv_msf.mexw64
MODELREF_LINK_LIBS        = D:/Full_EV_Model_WithBatTemp_Anomalous/EV/Work/slprj/sim/DrivetrainEv/DrivetrainEvlib.lib
...
DrivetrainEv_msf.obj : $(START_DIR)/slprj/sim/DrivetrainEv/DrivetrainEv_msf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/sim/DrivetrainEv/DrivetrainEv_msf.c
