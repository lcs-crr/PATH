...
#include "EvReferenceApplication_2ea1fbef_1_ds_nldv.h"
...
int32_T EvReferenceApplication_2ea1fbef_1_ds_nldv ( const NeDynamicSystem *
...
, false , false , false , false , false , false , false , false , false ,
false , false , false , false , false , false , false , false , false , false
, false , false , false , false , false , false } ; PmBoolVector out ;
int32_T b ; boolean_T t0 [ 337 ] ; ( void ) t1 ; ( void ) LC ; out = t2 ->
mNLDV ; for ( b = 0 ; b < 337 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; } for
( b = 0 ; b < 337 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) LC ; (
void ) t2 ; return 0 ; }
