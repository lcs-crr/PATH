...
#include "EvReferenceApplication_2ea1fbef_1_ds_vmf.h"
...
int32_T EvReferenceApplication_2ea1fbef_1_ds_vmf ( const NeDynamicSystem * LC
, const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static
boolean_T _cg_const_1 [ 337 ] = { false , true , false , false , true , false
...
LC ; out = t2 -> mVMF ; for ( b = 0 ; b < 337 ; b ++ ) { t0 [ b ] =
