...
#include "EVBatteryCoolingSystem_e473bc05_1_ds_nldv.h"
...
int32_T EVBatteryCoolingSystem_e473bc05_1_ds_nldv(const NeDynamicSystem *LC,
  const NeDynamicSystemInput *t1, NeDsMethodOutput *t2)
{
  static boolean_T _cg_const_1[337] = { false, false, false, false, false, true,
